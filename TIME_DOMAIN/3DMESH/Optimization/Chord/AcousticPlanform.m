...
C_VAR_R1 = [0.010:0.005:0.045];
C_VAR_R2 = [0.010:0.005:0.045];
C_VAR_R3 = [0.010:0.005:0.045];
C_VAR_R4 = [0.010:0.005:0.045];
...
%
dlmwrite('./RESULTATS/MATRICE.COMBINATOIRE.CHORD.dat',COMB_C');
%
for ycp=1:NNC
   %  
   fprintf(' CHORD # %i / %i \n',ycp,NNC)
