...
nt   = 51 ; Tobs=zeros(nt,1);AC=Tobs;Xtip=Tobs;Ytip=Tobs;Ztip=Tobs;
...
for nn=1:nt
   for k=1:N
      for j=1:NC
         ...
         [Tsrc_bis] = CoupledRTE(Tobs(nn),C0,P,W,Xsrc,Ysrc,Tobs(nn),X1,X2,X3,1e-5);
         %[Tsrc_bis] = RTE(Tobs(nn),C0,P,W,Xsrc,Ysrc,Tobs(nn),X1,X2,X3,1e-5);
